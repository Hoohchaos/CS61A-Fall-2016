...
def group_by_centroid(restaurants, centroids):
    ...
    """
    # BEGIN Question 4
    close=[[find_closest(restaurant_location(r),centroids) for r in restaurants][i] for i in range(len(restaurants))]
    rest=[restaurants[i] for i in range(len(restaurants))]
    return group_by_first(zip(close,rest))
    # END Question 4
...
def find_centroid(cluster):
    ...
    # BEGIN Question 5
    lon=[restaurant_location(i)[0] for i in cluster]
    lat=[restaurant_location(i)[1] for i in cluster]
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    best_pred,max_rsq=find_predictor(user,reviewed,feature_fns[0])
